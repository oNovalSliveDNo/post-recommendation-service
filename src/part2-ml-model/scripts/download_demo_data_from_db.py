...
def main():
    ...
    queries = {
        "user_data_1000": "SELECT * FROM public.user_data LIMIT 1000",
        "post_text_1000": "SELECT * FROM public.post_text_df LIMIT 1000",
        "feed_data_1000": "SELECT * FROM public.feed_data LIMIT 1000",
        "feed_data_like_1000": "SELECT * FROM public.feed_data WHERE action = 'like' LIMIT 1000"
    }
