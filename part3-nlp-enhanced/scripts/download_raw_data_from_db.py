...
def main():
    ...
    queries = {
        ...
        "post_text": "SELECT * FROM public.post_text_df",
        "feed_data_10000000": "SELECT * FROM public.feed_data LIMIT 10000000",
        "feed_data_like": "SELECT * FROM public.feed_data WHERE action = 'like' LIMIT 10000000"
    }
